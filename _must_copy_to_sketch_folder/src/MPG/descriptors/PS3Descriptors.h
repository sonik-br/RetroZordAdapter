...
// PS3 analog sticks only report 8 bits
...
static const uint8_t ps3_report_descriptor[] PROGMEM =
{
...
static const uint8_t ps3_hid_descriptor[] PROGMEM =
{
		0x09,								 // bLength
		...
		sizeof(ps3_report_descriptor), 0x00, // wDescriptorLength[0] 90 (dynamically updated)
};

static const uint8_t PS3_CONFIG_MAIN_LENGTH = 9;
static const uint8_t PS3_CONFIG_INTERFACE_LENGTH = 25;

#define PS3_INTERFACE(n) \
...
static const uint8_t ps3_configuration_descriptor[] PROGMEM =
{
...
static const uint8_t ps3_configuration_interface_descriptor[] PROGMEM  =
{
		// interface descriptor, USB spec 9.6.5, page 267-269, Table 9-12
	9,				               // bLength
	4,				               // bDescriptorType
