...
DynamicHID_::DynamicHID_(const char* serial) : PluggableUSBModule(1, 1, epType),
                rootNode(NULL), descriptorSize(0), protocol(DYNAMIC_HID_REPORT_PROTOCOL),
                idle(1), gp_serial(serial)
{
